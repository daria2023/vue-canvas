<template>
    <svg t="1679488636161" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2951"
        id="mx_n_1679488636173" width="200" height="200">
        <path
            ...
            fill="#ffffff" p-id="2952"></path>
        <path d="M284 526.4m-48 0a48 48 0 1 0 96 0 48 48 0 1 0-96 0Z" fill="#ffffff" p-id="2953"></path>
        <path d="M340 382.4m-48 0a48 48 0 1 0 96 0 48 48 0 1 0-96 0Z" fill="#ffffff" p-id="2954"></path>
        <path d="M484 302.4m-48 0a48 48 0 1 0 96 0 48 48 0 1 0-96 0Z" fill="#ffffff" p-id="2955"></path>
        <path d="M644 342.4m-48 0a48 48 0 1 0 96 0 48 48 0 1 0-96 0Z" fill="#ffffff" p-id="2956"></path>
        <path d="M724 470.4m-48 0a48 48 0 1 0 96 0 48 48 0 1 0-96 0Z" fill="#ffffff" p-id="2957"></path>
    </svg>
</template>
